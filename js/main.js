...
function initArticles() {
  ...
  setShareMeta({
    ...
    description: '41+ free reading guides and PDF book articles: vocabulary tips, English learning, classic reviews and legal download guides from LifeWithBooks.',
