...
const ARTICLES_MORE_6 = [
  {
    ...
    "body": [
      ...
      "Browse our IELTS Complete Preparation Guide (see book/ielts-complete-preparation-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our IELTS Academic Practice Tests Guide (see book/ielts-academic-practice-tests-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our IELTS Writing Task 1 and 2 Complete Guide (see book/ielts-writing-task-1-and-2-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our IELTS Speaking Practice Question Bank (see book/ielts-speaking-practice-question-bank.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our IELTS Listening Practice Guide (see book/ielts-listening-practice-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our IELTS Vocabulary Builder 3000 Words (see book/ielts-vocabulary-builder-3000-words.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our CSS English Essay Writing Guide (see book/css-english-essay-writing-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our CSS English Precis Writing Guide (see book/css-english-precis-writing-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our CSS Current Affairs Preparation (see book/css-current-affairs-preparation.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our CSS General Knowledge Guide (see book/css-general-knowledge-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our PMS Punjab Exam Preparation (see book/pms-punjab-exam-preparation.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our Matric English Grammar Complete (see book/matric-english-grammar-complete.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Matric Mathematics Solved Guide (see book/matric-mathematics-solved-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Matric Biology Notes Guide (see book/matric-biology-notes-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our FSc Physics Short Questions (see book/fsc-physics-short-questions.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our The Sealed Nectar — Prophet Biography (see book/the-sealed-nectar-prophet-biography.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Islam The Natural Way (see book/islam-the-natural-way.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Arabic for Beginners Guide (see book/arabic-for-beginners-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Islamic History Timeline (see book/islamic-history-timeline.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Quran Translation Guide English (see book/quran-translation-guide-english.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our Python Programming Beginner Guide (see book/python-programming-beginner-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our HTML CSS Web Design Basics (see book/html-css-web-design-basics.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "Browse our JavaScript Fundamentals Guide (see book/javascript-fundamentals-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "## Version Control With Git",
      "Every employer expects Git familiarity. Commit daily, write clear messages, learn branching for team projects.",
      "Browse our Git Version Control Guide (see book/git-version-control-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "## Data and SQL Basics",
      "Python pairs naturally with SQLite and PostgreSQL. Learn SELECT, JOIN and INSERT even if you are not becoming a DBA.",
      "Browse our SQL Database Beginner Guide (see book/sql-database-beginner-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our Aesop's Fables Complete (see book/aesops-fables.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "## Grimm's Fairy Tales",
      "Choose age-appropriate tales; some original versions are darker than Disney adaptations. Preview chapters first.",
      "Browse our Grimm's Fairy Tales Complete (see book/grimms-fairy-tales.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Arabian Nights Stories (see book/arabian-nights-stories.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "## Screen Time Balance",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our Cambridge IGCSE Preparation (see book/cambridge-igcse-preparation.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our O Level English Language Guide (see book/o-level-english-language-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "## O Level Mathematics",
      "Show working clearly; calculator and non-calculator papers need different drill sets.",
      "Browse our O Level Mathematics Guide (see book/o-level-mathematics-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "## A Level Biology",
      "Diagrams, definitions and long answers — build an error log from marked mock papers.",
      "Browse our A Level Biology Study Guide (see book/a-level-biology-study-guide.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "## A Level Psychology",
      "Evaluation paragraphs earn top marks; learn study names, findings and limitations as sets.",
      "Browse our A Level Psychology Notes (see book/a-level-psychology-notes.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our As a Man Thinketh (see book/as-a-man-thinketh.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our The Art of War (see book/the-art-of-war.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Acres of Diamonds (see book/acres-of-diamonds.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "## The Science of Getting Rich",
      "Wallace Wattles links gratitude, creative thinking and efficient action — read critically and apply what resonates.",
      "Browse our The Science of Getting Rich (see book/the-science-of-getting-rich.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      ...
      "Browse our Self Reliance — Ralph Emerson (see book/self-reliance-ralph-emerson.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our Pride and Prejudice (see book/pride-and-prejudice.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "Browse our The Adventures of Sherlock Holmes (see book/the-adventures-of-sherlock-holmes.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "Browse our Alice in Wonderland (see book/alice-in-wonderland.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our Pride and Prejudice (see book/pride-and-prejudice.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
      "Browse our Dracula (see book/dracula.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our Treasure Island (see book/treasure-island.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
  ...
  },
  {
    ...
    "body": [
      ...
      "Browse our FSc Chemistry Important Questions (see book/fsc-chemistry-important-questions.html on LifeWithBooks) guide on LifeWithBooks for a structured overview and study tips.",
